...
def update_movies_with_ids(movies, moviesIds):
    """
    This function updates a list of movie dictionaries with the ObjectIds generated by MongoDB after insertion.

    Args:
        movies: The list of movie dictionaries.
        moviesIds: The InsertManyResult object containing the inserted document IDs.

    Returns:
        The updated list of movie dictionaries with the '_id' field added.
    """
    for movie, inserted_id in zip(movies, moviesIds.inserted_ids):
        movie["_id"] = inserted_id  # Directly assign ObjectId to movie
    return movies
...
def create_db():
    ...
    update_movies_with_ids(movies, moviesIds)
    print(len(movies))
